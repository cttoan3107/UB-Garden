...
public class StatusBar {
    ...
    private final Text carrotsNumber = new Text();
    ...
    public StatusBar(Group root, int sceneWidth, int sceneHeight) {
        ...
        HBox carrotsStatus = statusGroup(ImageResourceFactory.getInstance().get(ImageResource.CARROTS), carrotsNumber);

        status.setSpacing(40.0);
        status.getChildren().addAll(diseaseLevelStatus, insecticideStatus, energyStatus,carrotsStatus);
    ...
    public void update(Game game) {
        ...
        energy.setText(String.valueOf(g.getEnergy()));
        diseaseLevel.setText(String.valueOf(g.getDiseaseLevel()));
        insecticideNumber.setText(String.valueOf(g.getInsecticideCount()));
        carrotsNumber.setText(String.valueOf(g.getCarrotsCollected()));
    }
